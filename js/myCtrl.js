app.controller("myCtrl", function ($scope, $http) {
    ...
    $scope.attemptAdoption = function (animalID, status) {
        ...
        if ($scope.formData.values.name === null || $scope.formData.values.name === '') {
            ...
            var numUsers = "", userID = "", getURL = "http://turningthetassel.com/francisco/angel_dogs/php/getNumUsers.php";
            $http.get(getURL)
                .then(function (response) {
                    ...
                    getURL = "http://turningthetassel.com/francisco/angel_dogs/php/addUser.php";
                    ...
                    $http({
                        ...
                        getURL = "http://turningthetassel.com/francisco/angel_dogs/php/adoptAnimal.php";
    ...
    $scope.getPhotos = function (option) {
        if (option === "animalsInNeed") {
            angular.forEach($scope.origAnimalsInNeed, function (iter) {
                var url = "http://turningthetassel.com/francisco/angel_dogs/php/getPhotos.php?id=" + iter.id;
                $http.get(url)
                    .then(function (response) {
    ...
    $http.get("http://turningthetassel.com/francisco/angel_dogs/php/getAnimalsInNeed.php")
        .then(function (response) {
    ...
    $http.get("http://turningthetassel.com/francisco/angel_dogs/php/getAdoptedAnimals.php")
    .then(function (response) {

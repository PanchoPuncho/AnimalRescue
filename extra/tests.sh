...
typeset addPicture=${pre}'/addPicture.php?id=111111&animalID=111111&photo=FrankPup.jpg';
...
typeset updateAnimal=${pre}'/updateAnimal.php?id=000000&name=Zuko&writeUp=Sleeps%20all%20night,%20naps%20all%20day.&species=Canine&breed=Cane%20Corso%20Mix&sex=Male&monthBorn=July&yearBorn=2012&aSize=Large%20(between%2060%20and%20100%20lbs)&monthFound=January&yearFound=2015&fixed=Yes&status=Adopted&rescuerID=000001&monthRescued=June&yearRescued=2015&age=null&years=null&photos=null'
